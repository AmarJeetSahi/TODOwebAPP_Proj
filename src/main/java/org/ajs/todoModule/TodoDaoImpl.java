...
public class TodoDaoImpl implements TodoDao {
	...
	private static final String INSERT_TODOS_SQL = "INSERT INTO todo.todos"
			+ "  (title, username, description, target_date,  is_done) VALUES " + " (?, ?, ?, ?, ?);";

	private static final String SELECT_TODO_BY_ID = "select id,title,username,description,target_date,is_done from todo.todos where id =?";
	private static final String SELECT_ALL_TODOS = "select * from todo.todos";
	private static final String DELETE_TODO_BY_ID = "delete from todo.todos where id = ?;";
	private static final String UPDATE_TODO = "update todo.todos set title = ?, username= ?, description =?, target_date =?, is_done = ? where id = ?;";
